  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="bg-black/30 p-8 rounded-lg border border-brand-silver/20 space-y-8">
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-brand-light">+27 (31) 555-0123 (Also on WhatsApp!)</span>
              </div>
              <div className="flex items-center gap-4">
                <EnvelopeIcon className="h-6 w-6 text-brand-blue"/>
                <a href="mailto:info@tandtauto.co.za" className="text-brand-light hover:text-brand-blue transition-colors">info@tandtauto.co.za</a>
              </div>
              <div className="flex items-start gap-4">
                <MapPinIcon className="h-6 w-6 text-brand-blue mt-1"/>
                <span className="text-brand-light">123 Ocean Drive, Isipingo Beach<br/>Durban, KwaZulu-Natal, 4133</span>
              </div>
            </div>
          </div>
          <div>
            <h2 className="font-sans text-2xl font-bold text-white mb-4">Workshop Hours</h2>
            <div className="space-y-2 text-brand-light">
        ...
        <div className="bg-black/30 h-96 rounded-lg border border-brand-silver/20 overflow-hidden">
            <iframe
