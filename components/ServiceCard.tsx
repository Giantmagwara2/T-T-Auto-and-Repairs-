...
const ServiceCard: React.FC<ServiceCardProps> = ({ service }) => {
  ...
  return (
    <div className="bg-black/30 p-6 rounded-lg shadow-lg border border-brand-silver/20 hover:border-brand-blue hover:shadow-brand-blue/20 transition-all duration-300 transform hover:-translate-y-2">
